...
namespace Modules\Discountable\Repositories\Eloquent;
...
class EloquentDiscountRepository extends EloquentBaseRepository implements DiscountRepository
{
    public function getItemsBy($params)
    {
        ...
        if ($params->filter) {
            ...
            /*if(isset($filter->entityType)){
                $query->whereHas('discountable',function($query) use($filter){
                    $query->where('discountable_type',$filter->entityType);
                });
            }*/
    ...
    public function create($data)
    {
        ...
        if (isset($data['rules']))
            $entity->rule(Arr::get($data, 'rules', []));
